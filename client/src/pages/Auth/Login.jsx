...
const Login = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col bg-blue-200 rounded-xl justify-center items-center p-10 gap-12 md:w-[700px] shadow-lg">
        <img src={logoSE} alt="" className="h-[180px] w-[350px]" />
        <form
        ...
        >
          ...
          <div className="text-blue-900">
            <p className="text-center">
              ...
              <Link
                to="/forget-password"
                className="cursor-pointer underline hover:text-cyan-500 duration-150"
              >
                Reset password here
              </Link>
            </p>
        ...
        <div className="flex gap-2 items-center justify-center text-blue-900 text-sm">
          <h1>Copyright</h1>
          <FaRegCopyright />
